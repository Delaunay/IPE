...
latex_documents = [
  (master_doc, 'IPE.tex', u'IPE Documentation',
...
man_pages = [
    (master_doc, 'IPE', u'IPE Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'IPE', u'IPE Documentation',
   author, 'IPE', 'Inter process exchange format',
   'Miscellaneous'),
]
